...
function Calendar({
  ...
  const [month, setMonth] = React.useState(dateSelected);
  ...
  const columnsDisplayed = navView === "years" ? 1 : numberOfMonths as number
  ...
  return (
    <DayPicker
      ...
      className={cn("p-3 custom-animate-calendar", className)}
      style={{
